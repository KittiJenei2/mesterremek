...
{{-- ÚJ: AZ ÉLŐ KERESŐ JAVASCRIPT KÓDJA --}}
@section('scripts')
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 1. Figyeljük a gépelést és a legördülő változását
    document.body.addEventListener('input', function(e) {
        if (e.target.closest('#szuroForm')) {
            clearTimeout(debounceTimer);
            // Vár 400ms-t gépelés után, hogy ne küldjön minden betűre külön kérést
            debounceTimer = setTimeout(() => { fetchResults(form); }, 400);
        }
    });

    // 2. Letiltjuk a gombos frissítést, ha mégis rányomnának
    ...
    // 3. Törlés gomb (X) logikája újratöltés nélkül
